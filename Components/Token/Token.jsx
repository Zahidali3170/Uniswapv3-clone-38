  ...
  return (
    <div className={Style.Token}>
        <div className={Style.Token_box}>
            ...
            <p className={Style.Token_box_para}> Slippage tolerance{""} <Image src={images.lock} alt="img" width={20} height={20}/></p>
             ...
             <div className={Style.Token_box_input}>
                ...
                <p className={Style.Token_box_para}>
                  Slippage tolerance{""}
                  <Image src={images.lock} alt = "img" width={10} height={20}/>
                </p>
